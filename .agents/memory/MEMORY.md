...
- [Session file security & AuthKeyDuplicatedError](session-file-security-and-authkey.md) — never git-track *.session files (this repo's remote is public!); AuthKeyDuplicatedError needs a fresh login, not just a restart.
